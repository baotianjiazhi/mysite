...
class LoginForm(forms.Form):
    username_or_email = forms.CharField(label='用户名', widget=forms.TextInput(attrs={'class': 'form-control',
...
class BindEmailForm(forms.Form):
    email = forms.EmailField(
        ...
        widget=forms.EmailInput(
            attrs={'class': 'form-control', 'placeholder': '请输入正确的邮箱地址'}
        )
    )
...
class ChangePasswordForm(forms.Form):
    ...
    new_password_again = forms.CharField(
        label='再输入一次密码',
        widget=forms.PasswordInput(attrs={'class': 'form-control', 'placeholder': '请再输入一次输入密码'}))
...
class ForgotPassword(forms.Form):
    email = forms.EmailField(
        label='邮箱',
        widget=forms.EmailInput(
            attrs={'class': 'form-control', 'placeholder': '请输入绑定的邮箱地址'}
        )
    )
    verification_code = forms.CharField(
        label='验证码',
